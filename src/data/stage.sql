...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 16 juil. 2022 à 20:35
...
(2, 'nada', '1657975941.jpg', NULL, NULL);
...
CREATE TABLE `produits` (
  ...
  `description_produit` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prix_produit` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_produit` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `produits` (`id_produit`, `nom_produit`, `description_produit`, `prix_produit`, `photo_produit`, `id_categorie`, `created_at`, `updated_at`) VALUES
(1, 'prid', 'vfffff', NULL, '1657975845.jpg', NULL, NULL, NULL),
(3, 'produit-4', 'kkkkkkkkk', '522', '1657976471.jpg', 2, NULL, NULL);
...
--
ALTER TABLE `produits`
  MODIFY `id_produit` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

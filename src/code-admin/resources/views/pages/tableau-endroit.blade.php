...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-3">
        <li class="breadcrumb-item"><a href="{{route('afficher-endroit.create')}}">Ajouter produit</a></li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                        
                            ...
                            <a href="{{route('afficher-endroit.edit',$value->id_produit)}}"><i class="item-action fa fa-edit" data-toggle="modal"
                                    data-target="#labelModal"></i></a>
                            
                                    <form action="{{route('afficher-endroit.destroy',$value->id_produit)}}" method="POST">
                                        @csrf
                                  @method("DELETE")

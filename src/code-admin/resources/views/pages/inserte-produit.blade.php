...
<div class="main-content">
   ...
   <strong>Ajouter les produits</strong>
   </h1>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('afficher-produit.store')}}"  method="POST" novalidate="novalidate"   enctype="multipart/form-data">
                                ...
                                @csrf 
                                   <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input id="cc-exp" name="prix_produit" type="nombre" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                    data-val-cc-exp="Please enter a valid month and year" 
                                                    autocomplete="cc-exp">
                                                <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="cc-pament" name="description_produit" type="text "class="form-control" aria-required="true" aria-invalid="false" value="100.00"> </textarea>
                                          </div>
                                    ...
                                    <div class="">
                                        <button style="background-color: #733003 ;color:aliceblue;"class="btn btn-info au-btn--block " type="submit"> Ajouter </button>
